...
namespace KutuphaneYonetimSistemi.Entities.Mapping
{
    public class UyeMap:EntityTypeConfiguration<Uye>
    {
        public UyeMap()
        {
            ...
            this.Property(c => c.Mail).IsOptional().HasMaxLength(150);
            this.Property(c => c.KullaniciAdi).IsRequired().HasMaxLength(15);
            this.Property(c => c.Sifre).IsRequired().HasMaxLength(15);
            this.Property(c => c.Fotograf).IsRequired().HasMaxLength(500);
            this.Property(c => c.Okul).IsRequired().HasMaxLength(150);
            ...
            this.Property(c => c.Fotograf).HasColumnName("Fotograf");
            this.Property(c => c.Okul).HasColumnName("Okul");
