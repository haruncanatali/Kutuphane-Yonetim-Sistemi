...
{
    public class KasaManager:ManagerCollection<Kasa,IKasaDal,KasaValidator>,IKasaService
    {
        public KasaManager(IKasaDal dal, KasaValidator validator) : base(dal, validator)
        {
        }
    }
}
